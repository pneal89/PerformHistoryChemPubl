...
class CourseStudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_student" do
    assert_difference('CourseStudent.count') do
      post course_students_url, params: { course_student: { attempt: @course_student.attempt, course_id: @course_student.course_id, grade: @course_student.grade, student_id: @course_student.student_id } }
    end
  ...
  test "should update course_student" do
    patch course_student_url(@course_student), params: { course_student: { attempt: @course_student.attempt, course_id: @course_student.course_id, grade: @course_student.grade, student_id: @course_student.student_id } }
