...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference('College.count') do
      post colleges_url, params: { college: { city: @college.city, county: @college.county, name: @college.name, state: @college.state, uid: @college.uid } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { city: @college.city, county: @college.county, name: @college.name, state: @college.state, uid: @college.uid } }
