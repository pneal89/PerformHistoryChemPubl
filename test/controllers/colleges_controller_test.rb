...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference('College.count') do
      post colleges_url, params: { college: { city: @college.city, country: @college.country, name: @college.name, school_id: @college.school_id, state: @college.state } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { city: @college.city, country: @college.country, name: @college.name, school_id: @college.school_id, state: @college.state } }
