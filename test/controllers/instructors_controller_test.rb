...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { fname: @instructor.fname, lname: @instructor.lname, rank: @instructor.rank } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { fname: @instructor.fname, lname: @instructor.lname, rank: @instructor.rank } }
